...
<div class="container">
  <div class="page-inner">
    <div class="page-header d-flex justify-content-between align-items-center">
      <h4 class="page-title mb-0">Edit Jam Mengajar</h4>
...
<form action="<?= site_url('admin/waktu_edit_go') ?>" method="post">
  <!-- Input hidden ID -->
  <input type="hidden" name="id" value="<?= $obj_waktu->id ?>">
    ...
    <select name="hari" id="hari" class="form-control" required>
      ...
      <?php
        ...
        foreach ($hari_list as $hari) {
          $selected = ($obj_waktu->hari == $hari) ? 'selected' : '';
  ...
  <div class="form-group mb-3">
    ...
    <input type="text" name="jam" id="jam" class="form-control" value="<?= $obj_waktu->jam ?>" required>
  </div>

  <button type="submit" class="btn btn-primary">Perbarui</button>
  <a href="<?= site_url('admin/waktu') ?>" class="btn btn-danger">Batal</a>
</form>
    </div>
  </div>
</div>
