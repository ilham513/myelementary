...
<div class="container">
  <div class="page-inner">
    <div class="page-header d-flex justify-content-between align-items-center">
      <h4 class="page-title mb-0">Input Data Guru</h4>
  ...
  <div class="form-group mb-3">
    <label for="nama_karyawan">Nama Guru</label>
    <input type="text" name="nama_karyawan" id="nama_karyawan" class="form-control" placeholder="Masukkan nama karyawan" required>
  </div>
  ...
  <div class="form-group mb-3">
    ...
    <input type="text" name="nomor_telpon" id="nomor_telpon" class="form-control" placeholder="Masukkan nomor telepon" required>
  </div>
